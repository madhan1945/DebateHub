...
const SOCIALS = [
  {
    name: 'GitHub',
    url: 'https://github.com/madhan1945',
  ...
  {
    name: 'Instagram',
    url: 'https://instagram.com/berserk_jinx',
    icon: <path d="M7 2h10a5 5 0 0 1 5 5v10a5 5 0 0 1-5 5H7a5 5 0 0 1-5-5V7a5 5 0 0 1 5-5zm5 3.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13zm0 2.5a4 4 0 1 1 0 8 4 4 0 0 1 0-8zm5.5-1A1.5 1.5 0 1 0 16 6a1.5 1.5 0 0 0 1.5 1.5z" fill="currentColor"/>,
    viewBox: '0 0 24 24',
  },
  {
    name: 'Discord',
    url: 'https://discord.com/users/madhan1945',
  ...
  return (
    <footer style={{ background: 'var(--bg-surface)', borderTop: '1px solid var(--border)', padding: '3rem 1.5rem 2rem' }}>
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(220px, 1.2fr) repeat(3, minmax(160px, 0.9fr)) minmax(250px, 1.1fr)', gap: '2.5rem', marginBottom: '2.5rem', alignItems: 'start' }}>
          <div>
          ...
          <div style={{ justifySelf: 'end', width: '100%', maxWidth: 280 }}>
            ...
            <p style={{ fontSize: '0.875rem', color: 'var(--text-muted)', lineHeight: 1.6, marginBottom: '0.55rem' }}>For collaborations, support, or feature ideas, reach us here:</p>
            <a href="mailto:debatehub@gmail.com" style={{ display: 'inline-block', fontSize: '0.95rem', color: 'var(--brand)', textDecoration: 'none', fontWeight: 600, marginBottom: '1.4rem', transition: 'opacity 0.2s' }} onMouseEnter={e => e.target.style.opacity = 0.8} onMouseLeave={e => e.target.style.opacity = 1}>
              debatehub@gmail.com
            </a>

            <div>
              <h4 style={{ fontSize: '0.8rem', fontWeight: 600, color: 'var(--text-primary)', textTransform: 'uppercase', letterSpacing: '0.06em', marginBottom: '0.85rem' }}>Follow Us</h4>
              <div style={{ display: 'flex', gap: '0.875rem', alignItems: 'center' }}>
                {SOCIALS.map(s => (
                  <a key={s.name} href={s.url} target="_blank" rel="noopener noreferrer" style={{ width: 32, height: 32, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--bg-elevated)', border: '1px solid var(--border)', borderRadius: 8, color: 'var(--text-muted)', transition: 'all 0.2s', textDecoration: 'none' }}
                    ...
                    title={s.name}
                  >
                    <svg width="15" height="15" viewBox={s.viewBox} fill="none">
                      {s.icon}
                    </svg>
                  </a>
                ))}
